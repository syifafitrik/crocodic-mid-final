                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100 gap-3">
                        <div class="text-center mb-11">
                            ...
                            <div class="text-gray-500 fw-semibold fs-6">Mulai Langkah Awaal Registrasi dengan Mengisi Formulir dan Mendaftarkan Akun Baru Anda </div>
                        </div>
                        <div class="my-2"></div>
    ...
    <script>
        ...
        function go_login() {
            ...
            if (data_email == null || data_email == '') {
                blockUI.close();
                toastr.errorHtml('Email harus diisi Woyy!');
                return;
            }
