        ...
        <form id="form-login">
            <div class="card-body">
                <div class="d-flex flex-column h-100 gap-3">
                    ...
                    <input type="password" placeholder="Masukkan Password" name="password" id="password" autocomplete="off"
                        class="form-control form-control-sm bg-transparent" />
                    <div class="">
                        <small>Belum punya akun? Registrasi <a type="button" href="{{ route('register') }}">di
                                sini</a></small>
                    </div>
                    <div class="my-5"></div>
